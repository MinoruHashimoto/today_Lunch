...
<div class="body">
	...
	<a href="/today_Lunch/ManageServlet"></a> 
	<br> <br>［現在ログインしています］
 ...
 %>
	...
	<form action="/today_Lunch/AdminServlet" method="post">
		<table class="T_table">
			<tr>
				<td><input type="text" class="form" placeholder="店舗名" name="name" 
				required title="1文字以上の文字列" required/></td>
			</tr>
			<tr>
				<td><input type="text" class="form" placeholder="ジャンル" name="janru" required pattern="和食|洋食|中華" 
					title="「和食」「洋食」「中華」のうちどれか一つ" required/></td>
			</tr>
			<tr>
				<td><input type="text" class="form" placeholder="距離区分" name="distance" required title="1文字以上の文字列" required/></td>
			</tr>
			<tr>
				<td><input type="text" class="form" placeholder="定休日" name="holiday" required title="1文字以上の文字列" required/></td>
			</tr>
			<tr>
				<td><input type="tel" class="form" placeholder="電話番号" name="tel" pattern="\d{2,4}-\d{3,4}-\d{3,4}" title="電話番号の形式　(例)090-1234-5678" required/></td>
			</tr>
			<tr>
				<td><input type="tel" class="form" placeholder="値段区分" name="price" pattern="\d+" title="1文字以上の数字" required/></td>
			</tr>
			<tr>
				<td><input type="text" class="form" placeholder="定番メニュー" name="dishes" title="1文字以上の数字" required/></td>
			</tr>
			<tr>
				<td><input type="url" class="form" placeholder="URL" name="url" required/></td>
			</tr>
		</table>
		<pre>
		</pre>
